...
describe('Card', () => {
  ...
  it('Outline Card', () => {
    const component = shallow(<Card outline title={'Test title'} theme={'danger'}>Test Card</Card>);
    expect(component).toMatchSnapshot();
  });
  it('Card with icon', () => {
    const component = shallow(<Card outline title={'Test title'} icon={<span>icon</span>} theme={'danger'}>Test Card</Card>);
    expect(component).toMatchSnapshot();
  });
